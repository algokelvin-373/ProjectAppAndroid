...
public class SamplePrintVersionTwoActivity extends AppCompatActivity {
    private static final String TAG = "SamplePrintVersionTwoActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnPrnText = findViewById(R.id.btn_prnBill);
        printInfo = findViewById(R.id.printer_info);

        //Set printer gray value
        mEtHue = findViewById(R.id.et_hue);
        mBtSetHue = findViewById(R.id.bt_set_hue);
        ...
        mBtnPrnBitmap.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                new AlertDialog.Builder(SamplePrintVersionTwoActivity.this)
        ...
        mBtnPrnBarcode.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String message = printInfo.getText().toString();
                if (message.length() > 0) {
                    mBtnPrnBitmap.setEnabled(false);
                    mBtnPrnBarcode.setEnabled(false);
                    mBtnForWard.setEnabled(false);
                    ...
                    Toast.makeText(SamplePrintVersionTwoActivity.this, R.string.tst_hint_content, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        ArrayAdapter mBarcodeTypeAdapter = ArrayAdapter.createFromResource(
                SamplePrintVersionTwoActivity.this, R.array.barcode_type,
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (status == PRNSTS_OUT_OF_PAPER) {
                    Toast.makeText(
                            SamplePrintVersionTwoActivity.this,
