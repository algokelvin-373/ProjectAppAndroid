...
import algokelvin.app.fragmentapps.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun ActivityMainBinding.main() {
        btnFragmentOne.setOnClickListener {
            setFragment(supportFragmentManager, OneFragment::class.java.simpleName, OneFragment())
        }
        btnFragmentTwo.setOnClickListener {
            setFragment(supportFragmentManager, TwoFragment::class.java.simpleName, TwoFragment())
        }
    }
