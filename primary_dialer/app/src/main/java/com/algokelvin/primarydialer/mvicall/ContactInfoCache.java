...
import com.algokelvin.primarydialer.mvicall.common.PhoneNumberHelper;
    ...
    public void maybeInsertCnapInformationIntoCache(Context context, final Call call,
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                CachedNumberLookupService.CachedContactInfo cacheInfo = mCachedNumberLookupService.buildCachedContactInfo(contactInfo);
                cacheInfo.setSource(CachedNumberLookupService.CachedContactInfo.SOURCE_TYPE_CNAP, "CNAP", 0);
