...
import com.sbi.mvicalllibrary.icallservices.widgetDialpad.widget.FloatingActionButtonController;
...
//    private FrameLayout videoViewWrapper, frameFullScreen;
//    private ConstraintLayout constraintRatio;
//    private RelativeLayout mRelaBottomBg;
...
//    private TextView mPrimaryMsisdn;
...
//    private ConstraintLayout mCtFullscreen;
//    private RelativeLayout mRlDialerBg;

//    private ImageView mImgBgUser;
...
//        mPrimaryName = view.findViewById(R.id.name);
//        mPrimaryMsisdn = view.findViewById(R.id.tvMsisdn);
//        mNumberLabel = view.findViewById(R.id.label);
...
//        mCallStateIcon = view.findViewById(R.id.callStateIcon);
//        mCallStateVideoCallIcon = view.findViewById(R.id.videoCallIcon);
//        mCallStateLabel = view.findViewById(R.id.callStateLabel);
//        mHdAudioIcon = view.findViewById(R.id.hdAudioIcon);
//        mForwardIcon = view.findViewById(R.id.forwardIcon);
//        mCallNumberAndLabel = view.findViewById(R.id.labelAndNumber);
//        mCallTypeLabel = view.findViewById(R.id.callTypeLabel);
//        mElapsedTime = view.findViewById(R.id.elapsedTime);
        mPrimaryCallCardContainer = view.findViewById(R.id.primary_call_info_container);
//        mCallButtonsContainer = view.findViewById(R.id.callButtonFragment);
//        mInCallMessageLabel = view.findViewById(R.id.connectionServiceMessage);
//        mProgressSpinner = view.findViewById(R.id.progressSpinner);
//        mPhoto = view.findViewById(R.id.photo);
//        mImgBgUser = view.findViewById(R.id.ivBgDetail);
//        videoViewWrapper = view.findViewById(R.id.videoViewWrapper);
//        constraintRatio = view.findViewById(R.id.constraintRatio);
//        mRelaBottomBg = view.findViewById(R.id.rela);
//        frameFullScreen = view.findViewById(R.id.frameFullDialer);
//        mCtFullscreen = view.findViewById(R.id.constraintFullscreen);
//        mRlDialerBg = view.findViewById(R.id.rlBgDialerPurple);
//        dialerLogo = view.findViewById(R.id.dialer_logo);
//
//        mFloatingActionButtonContainer = view.findViewById(R.id.floating_end_call_action_button_container);
//        mFloatingActionButton = view.findViewById(R.id.floating_end_call_action_button);
//        mFloatingActionButton.setOnClickListener(v -> getPresenter().endCallClicked());
//        mFloatingActionButtonController = new FloatingActionButtonController(getActivity(), mFloatingActionButtonContainer, mFloatingActionButton);
//
//        mSecondaryCallInfo.setOnClickListener(v -> {
...
//        mManageConferenceCallButton.setOnClickListener(v -> {
...
//        mCallSubject = view.findViewById(R.id.callSubject);
...
//        set.clone(constraintRatio);
//        set.setDimensionRatio(videoViewWrapper.getId(), _ratio);
//        set.applyTo(constraintRatio);
    }
