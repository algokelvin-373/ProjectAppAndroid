...
public abstract class AccountType {
     ...
     */
    private final ArrayList<DataKind> mKinds = Lists.newArrayList();

    /**
     * Lookup map of {@link #mKinds} on {@link DataKind#mimeType}.
     */
    private final HashMap<String, DataKind> mMimeKinds = Maps.newHashMap();
     ...
     */
    private static final Comparator<DataKind> sWeightComparator = new Comparator<DataKind>() {
        @Override
