...
import com.sbi.mvicalllibrary.icallservices.Call.State;
...
import com.sbi.mvicalllibrary.icallservices.InCallVideoCallCallbackNotifier.SessionModificationListener;
 ...
 */
class VideoPauseController implements InCallStateListener, IncomingCallListener, SessionModificationListener {
     ...
     * {@link com.sbi.mvicalllibrary.icallservices.InCallPresenter}.
     *
     * @param inCallPresenter The {@link com.sbi.mvicalllibrary.icallservices.InCallPresenter}.
     */
     ...
     * internal state.  Called from {@link com.sbi.mvicalllibrary.icallservices.InCallPresenter}.
     */
    ...
    private static boolean isIncomingCall(Call call) {
        return call != null && (call.getState() == Call.State.CALL_WAITING || call.getState() == Call.State.INCOMING);
    }
