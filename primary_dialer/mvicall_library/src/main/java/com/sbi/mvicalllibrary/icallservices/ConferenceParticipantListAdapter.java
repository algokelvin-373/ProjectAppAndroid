...
import com.sbi.mvicalllibrary.icallservices.common.ContactPhotoManager.DefaultImageRequest;
...
public class ConferenceParticipantListAdapter extends BaseAdapter {
     ...
     */
    private final View.OnClickListener mDisconnectListener = new View.OnClickListener() {
        @Override
     ...
     */
    private final View.OnClickListener mSeparateListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            View parent = (View) v.getParent();
            String callId = (String) parent.getTag();
     ...
     */
    private final List<ParticipantInfo> mConferenceParticipants = new ArrayList<>();
    ...
    private final void setCallerInfoForRow(View view, String callerName, String callerNumber,
        ...
        final TextView numberTypeTextView = view.findViewById(
