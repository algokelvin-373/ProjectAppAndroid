...
public class SelectPhoneAccountDialogFragment extends DialogFragment {
     ...
     */
    public static SelectPhoneAccountDialogFragment newInstance(List<PhoneAccountHandle> accountHandles, SelectPhoneAccountListener listener) {
        return newInstance(R.string.select_phone_account_for_calls, false, accountHandles, listener);
    }
     ...
     * @param listener       The listener for the results of the account selection.
     */
    public static SelectPhoneAccountDialogFragment newInstance(int titleResId, boolean canSetDefault, List<PhoneAccountHandle> accountHandles, SelectPhoneAccountListener listener) {
    ...
    public static class SelectPhoneAccountListener extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            if (resultCode == RESULT_SELECTED) {
                onPhoneAccountSelected(resultData.getParcelable(EXTRA_SELECTED_ACCOUNT_HANDLE), resultData.getBoolean(EXTRA_SET_DEFAULT));
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final DialogInterface.OnClickListener selectionListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                result.putParcelable(SelectPhoneAccountListener.EXTRA_SELECTED_ACCOUNT_HANDLE, selectedAccountHandle);
        ...
        ListAdapter selectAccountListAdapter = new SelectAccountListAdapter(builder.getContext(), R.layout.select_account_list_item, mAccountHandles);

        AlertDialog dialog = builder.setTitle(mTitleResId).setAdapter(selectAccountListAdapter, selectionListener).create();
        ...
        if (mCanSetDefault) {
            ...
            CheckBox cb = checkboxLayout.findViewById(R.id.default_account_checkbox_view);
    ...
    private class SelectAccountListAdapter extends ArrayAdapter<PhoneAccountHandle> {
        ...
        public SelectAccountListAdapter(Context context, int resource, List<PhoneAccountHandle> accountHandles) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (account.getAddress() == null || TextUtils.isEmpty(account.getAddress().getSchemeSpecificPart())) {
                holder.numberTextView.setVisibility(View.GONE);
            } else {
                holder.numberTextView.setVisibility(View.VISIBLE);
                holder.numberTextView.setText(PhoneNumberUtilsCompat.createTtsSpannable(account.getAddress().getSchemeSpecificPart()));
            }
            holder.imageView.setImageDrawable(PhoneAccountCompat.createIconDrawable(account, getContext()));
            return rowView;
        }
