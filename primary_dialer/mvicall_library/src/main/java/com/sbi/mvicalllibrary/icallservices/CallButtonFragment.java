...
import static com.sbi.mvicalllibrary.icallservices.CallButtonFragment.Buttons.BUTTON_COUNT;
...
import static com.sbi.mvicalllibrary.icallservices.CallButtonFragment.Buttons.BUTTON_MANAGE_VIDEO_CONFERENCE;
...
public class CallButtonFragment extends BaseFragment<CallButtonPresenter, CallButtonPresenter.CallButtonUi> implements CallButtonPresenter.CallButtonUi, OnMenuItemClickListener, OnDismissListener, View.OnClickListener {
    ...
    private final SparseIntArray mButtonVisibilityMap = new SparseIntArray(BUTTON_COUNT);
