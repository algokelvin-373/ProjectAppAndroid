...
public class MoreContactUtils {
    ...
    public static void setHeaderViewBottomPadding(Context context, TextView textView, boolean isFirstRow) {
        ...
        if (isFirstRow) {
            topPadding = (int) context.getResources().getDimension(R.dimen.frequently_contacted_title_top_margin_when_first_row);
        } else {
            topPadding = (int) context.getResources().getDimension(R.dimen.frequently_contacted_title_top_margin);
        }
