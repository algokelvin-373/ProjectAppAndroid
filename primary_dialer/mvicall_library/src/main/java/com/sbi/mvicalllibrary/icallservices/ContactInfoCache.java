...
import com.sbi.mvicalllibrary.icallservices.CachedNumberLookupService.CachedContactInfo;
import com.sbi.mvicalllibrary.icallservices.Utils.MoreStrings;
import com.sbi.mvicalllibrary.icallservices.common.PhoneNumberHelper;
import com.sbi.mvicalllibrary.icallservices.incalluibind.ObjectFactory;
...
//    private final CachedNumberLookupService mCachedNumberLookupService;
    ...
    private ContactInfoCache(Context context) {
        ...
        mCachedNumberLookupService = ObjectFactory.newCachedNumberLookupService();
    }
    ...
    public static ContactCacheEntry buildCacheEntryFromCall(Context context, Call call,
        ...
        ContactInfoCache.populateCacheEntry(context, info, entry, call.getNumberPresentation(), isIncoming);
    ...
    public void findInfo(final Call call, final boolean isIncoming,
         ...
         */
        final CallerInfo callerInfo = CallerInfoUtils.getCallerInfoForCall(mContext, call, new FindInfoCallback(isIncoming));
    ...
    private ContactCacheEntry buildEntry(Context context, String callId,
        ...
        msisdn = TextUtils.isEmpty(info.phoneNumber)?"" : info.phoneNumber;
     ...
     */
    public static void populateCacheEntry(Context context, CallerInfo info, ContactCacheEntry cce, int presentation, boolean isIncoming) {
     ...
     */
    private static String getPresentationString(Context context, int presentation, String customLabel) {
        String name = TextUtils.isEmpty(msisdn)?context.getString(R.string.unknown):msisdn;
