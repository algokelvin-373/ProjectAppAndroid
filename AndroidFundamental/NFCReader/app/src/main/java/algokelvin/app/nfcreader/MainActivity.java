package algokelvin.app.nfcreader;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intentNfc = new Intent(this,this.getClass());
        pendingIntent = PendingIntent.getActivity(this,0, intentNfc.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP),0);
    ...
    private void resolveIntent(Intent intent) {
        ...
        boolean nfcTag = NfcAdapter.ACTION_TAG_DISCOVERED.equals(action);
        boolean nfcTeach = NfcAdapter.ACTION_TECH_DISCOVERED.equals(action);
        boolean nfcNdef = NfcAdapter.ACTION_NDEF_DISCOVERED.equals(action);
            ...
            if (tech.equals(MifareClassic.class.getName())) {
                ...
                try {
                    ...
                    switch (mifareTag.getType()) {
                        case MifareClassic.TYPE_CLASSIC: type = "Classic";
                            break;
                        case MifareClassic.TYPE_PLUS: type = "Plus";
                            break;
                        case MifareClassic.TYPE_PRO: type = "Pro";
                            break;
                    }
