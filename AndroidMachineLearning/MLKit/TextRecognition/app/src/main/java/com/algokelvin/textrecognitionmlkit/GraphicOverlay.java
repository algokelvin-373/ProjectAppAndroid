...
public class GraphicOverlay extends View {
     ...
     * instances to the overlay using {@link com.algokelvin.textrecognitionmlkit.GraphicOverlay#add(Graphic)}.
     */
    public abstract static class Graphic {
        private com.algokelvin.textrecognitionmlkit.GraphicOverlay overlay;

        public Graphic(com.algokelvin.textrecognitionmlkit.GraphicOverlay overlay) {
