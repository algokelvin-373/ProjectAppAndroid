...
class MediaCodecAudioEncoder2(
    ...
    private fun setupAudioRecord() {
        ...
        if (CLog.isDebug()) {
            Log.i(logTag, "setupAudioRecord() -> audioFormatChannel: $audioFormatChannel, audioFormat: $audioFormat, minimumBufferSize: $minimumBufferSize")
        }
    ...
    fun stop() {
        ...
        try {
            ...
            if (CLog.isDebug()) {
                Log.i(logTag, "Error on audioRecorder stop. Safely ignore")
            }
            Log.iPrintStackTrace(e)
        }
        ...
        try {
            ...
            if (CLog.isDebug()) {
                Log.i(logTag, "Error on mediaCodec stop. Safely ignore")
            }
            Log.iPrintStackTrace(e)
        }
        ...
        try {
            ...
            if (CLog.isDebug()) {
                Log.i(logTag, "Error on mediaMuxer stop. Safely ignore")
            }
            Log.iPrintStackTrace(e)
        }
